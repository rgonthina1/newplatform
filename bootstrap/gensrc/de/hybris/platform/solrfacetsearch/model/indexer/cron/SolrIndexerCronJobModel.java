...
public class SolrIndexerCronJobModel extends CronJobModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>SolrIndexerCronJob.indexerHints</code> attribute defined at extension <code>solrfacetsearch</code>. */
	private Map<String,String> _indexerHints;
	...
	{
		if (this._indexerHints!=null)
		{
			return _indexerHints;
		}
		return _indexerHints = getPersistenceContext().getValue(INDEXERHINTS, _indexerHints);
	}
	...
	{
		_indexerHints = getPersistenceContext().setValue(INDEXERHINTS, value);
	}
