...
public class OrderModel extends AbstractOrderModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>Order.placedBy</code> attribute defined at extension <code>commerceservices</code>. */
	private UserModel _placedBy;
	...
	{
		if (this._placedBy!=null)
		{
			return _placedBy;
		}
		return _placedBy = getPersistenceContext().getValue(PLACEDBY, _placedBy);
	}
	...
	{
		_placedBy = getPersistenceContext().setValue(PLACEDBY, value);
	}
